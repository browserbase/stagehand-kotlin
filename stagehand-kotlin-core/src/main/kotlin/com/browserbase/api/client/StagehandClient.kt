...
interface StagehandClient {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): StagehandClient
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): StagehandClient.WithRawResponse
