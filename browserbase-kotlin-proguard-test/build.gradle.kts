...
dependencies {
    testImplementation(project(":browserbase-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../browserbase-kotlin-core/src/main/resources/META-INF/proguard/browserbase-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../browserbase-kotlin-core/src/main/resources/META-INF/proguard/browserbase-kotlin-core.pro",
