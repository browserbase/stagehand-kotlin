...
dependencies {
    testImplementation(project(":stagehand-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../stagehand-kotlin-core/src/main/resources/META-INF/proguard/stagehand-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../stagehand-kotlin-core/src/main/resources/META-INF/proguard/stagehand-kotlin-core.pro",
