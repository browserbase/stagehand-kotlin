...
/**
 * Local Stagehand server + multiregion Browserbase example (SSE streaming by default).
 *
 ...
 * - MODEL_API_KEY
 *
 * Optional: STAGEHAND_API_URL or STAGEHAND_BASE_URL for a local Stagehand server
 */
fun main() {
    Env.load()
